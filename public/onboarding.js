...
function showTourStep(step) {
    const steps = [
        {
            ...
            description: 'Fill out this form to log customer issues. The system will analyze tone, priority, and suggest knowledge base articles.',
            element: '.triage-form',
            position: 'bottom'
        },
        {
            title: 'View Client History',
            description: 'Click here to see all past reports, search by customer, and track resolution status.',
        ...
        },
        {
            ...
            description: 'Use Ctrl+K to search, Ctrl+N for new triage, Ctrl+/ to see all shortcuts.',
            element: 'body',
            position: 'center'
        },
        {
            title: 'Dark Mode',
            description: 'Toggle dark mode anytime using this button for comfortable viewing.',
    ...
    let tooltipStyle = 'position: fixed; background: white; border-radius: 10px; padding: 25px; max-width: 350px; box-shadow: 0 10px 40px rgba(0,0,0,0.3); z-index: 9999;';
